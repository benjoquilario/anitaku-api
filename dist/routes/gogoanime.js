...
const gogocdn_1 = require("../extractors/gogocdn");
const streamsb_1 = require("../extractors/streamsb");
        ...
        switch (server) {
            case types_1.StreamingServers.GogoCDN:
                return {
                    ...
                    sources: await (0, gogocdn_1.extract)(serverUrl),
            ...
            case types_1.StreamingServers.StreamSB:
                return {
                    ...
                    sources: await (0, streamsb_1.extract)(serverUrl),
                    download: downloadUrl
                        ? downloadUrl
                        : `https://${serverUrl.host}/download${serverUrl.search}`,
                };
